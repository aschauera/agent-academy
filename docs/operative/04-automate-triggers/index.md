...
1. Open the [Resume Table Updated JSON file](https://raw.githubusercontent.com/microsoft/agent-academy/refs/heads/main/docs/operative/04-automate-triggers/assets/3.2_ResumeTableUpdated.json), copy its entire contents, and paste them into the Adaptive Card field.
